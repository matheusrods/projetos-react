...
const CanceledActionsDetails = ({ PermissionStore: { hasPermission } }) => {
            ...
            <Container>
                ...
                <Content>
                    {loading ? (
                        ...
                        <Fragment>
                            <PageTitle>Detalhes de cancelamento</PageTitle>
                            <JustificationCard>
                                <ActionLabel>
                ...
                <ConfirmCancelFooter
                    ...
                    onCancel={() => history.push(`/canceled-actions/details/${id}/refuse/${lastRequest.id}`)}
                />
            </Container>
            <ModalComplex
                title={"Cancelar?"}
                description={"Ao avançar, a solicitação será confirmada. Este ato não pode ser revertido. Tem certeza que deseja postergar esta ação?"}
                nameModal={"confirm"}
...
export default inject("PermissionStore")(observer(CanceledActionsDetails));
