...
const CanceledActionsDetailsRefuse = ({ PermissionStore: { hasPermission } }) => {
    ...
    return hasPermission(12) ? (
        <Fragment>
            ...
            <Container>
                <WhiteHeader
                    title={"Detalhes de cancelamento"}
...
export default inject("PermissionStore")(observer(CanceledActionsDetailsRefuse));
