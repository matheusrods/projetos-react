...
export const SafetyId = styled.div`
    cursor: pointer;
    font-weight: 500;
    color: ${colors.gray5};
    font-size: 11px;
...
export const SafetyLabel = styled.div`
...
export const SafetyInfo = styled.div`
    border-top: 1px solid ${colors.grayBorder};
    padding-top: 16px;
    display: flex;
    justify-content: space-between;
...
export const SafetyUser = styled.span`
    font-size: 12px;
    color: ${colors.gray6};
`;

export const SafetyDate = styled.span`
    font-size: 11px;
    color: ${colors.gray5};
`;

export const SafetyStatus = styled.div`
    font-size: 12px;
    font-weight: 500;
    display: flex;
    justify-content: center;
